...
(function( factory ) {
   if ( typeof define === "function" && define.amd ) {
      define( [ 'JSRootCore', 'd3', 'JSRootPainter.hist', 'threejs_jsroot', 'JSRoot3DPainter'], factory );
   } else if (typeof exports === 'object' && typeof module !== 'undefined') {
      let jsroot = require("./JSRootCore.js");
      factory(jsroot, require("d3"), require("./JSRootPainter.hist.js"), require("./three.extra.min.js"), require("./JSRoot3DPainter.js"),
      ...
      factory(JSROOT, d3, JSROOT, THREE, JSROOT);
   }
